"""
buyer_client.py - Low-level TCP Connection Management

This module handles all TCP socket operations:
...
class BuyerClient:
    """
    Low-level TCP client for buyer-server communication.
    
    Handles the raw socket operations and message protocol.
    Does NOT know about specific APIs like Login, AddToCart, etc.
    """
